import { sanitizeSummaryStrings } from "./summarySanitizer.js";
...
export function applySummaryFallback(summary, transcript) {
  ...
  return {
    decisions: sanitizeSummaryStrings(summary?.decisions),
    keyPoints: sanitizeSummaryStrings(keyPoints),
    nextSteps: sanitizeSummaryStrings(nextSteps),
    actionItems,
  };
}
